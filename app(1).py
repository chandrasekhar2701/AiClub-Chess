...
PREDICTED_LABELS =["Bishop", "King","Knight","Pawn","Queen","Rook"] # edit 1
PREDICTED_LABELS.sort()

def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/ec6b3031-13a0-4076-8956-73b97f5fad6b'  #Edit 2
...
st.title("Welcome to Chess Image Classifier Web App!")#change according to your project   #edit 3
...
with tab1:
  #setting up the title
  st.header("Chess Image Classifier")#change according to your project   #edit 3
...
with tab2:
  ...
  #add github link
  st.link_button("My Github Repository", "https://github.com/chandrasekhar2701/AiClub-Chess")
  ...
  pdf_url = "https://raw.githubusercontent.com/chandrasekhar2701/AiClub-Chess/blob/main/sample.pdf"
